...
export function get<MI1 extends Prefix<ReqRes>>(
  params:
    | {
        path: string;
      }
...
export function get<MI1 extends Prefix<ReqRes>, MO1 extends Prefix<ReqRes>>(
  params:
    | {
        path: string;
      }
...
export function get<MI1 extends Prefix<ReqRes>, MO1 extends Prefix<ReqRes>, MO2 extends Prefix<ReqRes>>(
  params:
    | {
        path: string;
      }
