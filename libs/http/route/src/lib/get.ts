...
export function get<MI1 extends ReqRes>(
  params:
    | {
        path: string;
      }
...
export function get<MI1 extends ReqRes, MO1 extends ReqRes>(
  params:
    | {
        path: string;
      }
...
export function get<MI1 extends ReqRes, MO1 extends ReqRes, MO2 extends ReqRes>(
  params:
    | {
        path: string;
      }
