...
describe('easyocr', () => {
  ...
  describe(`arch: ${arch}`, async () => {
    ...
    it('should ocr and detect from agrisano sample', async () => {
      ...
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/agrisano.json');
    });
    ...
    it('should ocr and detect from agrisano sample with increased batch_size', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/agrisano_batch_size.json');
    });
    ...
    it('should ocr and detect from agrisano sample with increased worker', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/agrisano_worker.json');
    });
    ...
    it('should ocr and detect from helsana sample', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/helsana.json');
    });
    ...
    it('should ocr and detect from helsana sample with increased batch_size ', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/helsana_batch_size.json');
    });
    ...
    it('should ocr and detect from helsana sample with increased worker', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/helsana_worker.json');
    });
    ...
    it('should ocr and detect from sanitas sample', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/sanitas.json');
    });
    ...
    it('should ocr and detect from sanitas sample with increased batch_size', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/sanitas_batch_size.json');
    });
    ...
    it('should ocr and detect from sanitas sample with increased worker', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/sanitas_worker.json');
    });
    ...
    it('should ocr and detect from sumiswalder sample', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/sumiswalder.json');
    });
    ...
    it('should ocr and detect from sumiswalder sample with increased batch_size', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/sumiswalder_batch_size.json');
    });
    ...
    it('should ocr and detect from sumiswalder sample with increased worker', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/sumiswalder_worker.json');
    });
    ...
    it('should ocr and detect from sympany sample', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/sympany.json');
    });
    ...
    it('should ocr and detect from sympany sample with increased batch_size', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/sympany_batch_size.json');
    });
    ...
    it('should ocr and detect from sympany sample with increased worker', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/sympany_worker.json');
    });
    ...
    it('should ocr and detect from visana sample', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/visana.json');
    });
    ...
    it('should ocr and detect from visana sample with increased batch_size', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/visana_batch_size.json');
    });
    ...
    it('should ocr and detect from visana sample with increased worker', async () => {
      ...
      expect(response.statusCode).toBe(200);
      await expect(JSON.parse(text)).toMatchSnapshot('snapshots/visana_worker.json');
    });
  });
});
